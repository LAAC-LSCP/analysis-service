...
#### Commits
We require commits to follow the [conventional commits](https://www.conventionalcommits.org/en/v1.0.0/) scheme, enforced by [commitlint](https://commitlint.js.org/).
...
```note
Note: if squashing or rebasing, the commit message must conform to commitlint's rules.
```
