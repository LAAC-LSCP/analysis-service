# Copied completely from
# https://github.com/arxaqapi/speech-maturity/blob/main/scripts/infer.py
# But changed to let me pass in "device" option
...
if __name__ == "__main__":
    ...
    # Parse known args so you don't interfere with sb.parse_arguments
    ...
    for module in hparams["modules"].keys():
        hparams["modules"][module] = hparams["modules"][module].to(run_opts["device"])
    ...
    emo_id_brain.modules.to(run_opts["device"])
